...
from utils import Variable, seq_to_smiles, fraction_valid_smiles, unique, sa_score, percentage_easy_sa
...
def train_agent(restore_prior_from='data/Prior.ckpt',
    ...
    for step in range(n_steps):
        ...
        sa[0].append(step + 1)
        sa[1].append(percentage_easy_sa(smiles))
        ...
        logger.log(np.array(sa), "Synthetic Accessibility")
